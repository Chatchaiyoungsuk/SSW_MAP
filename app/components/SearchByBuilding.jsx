...
export default function SearchByBuilding(){
    ...
    return(
        <>
            <div>
                <input type="text" placeholder="ค้นหาชื่ออาคาร" value={search} onChange={searchHandle} className="mb-2 bg-zinc-900 outline-none w-full rounded-xl p-2 focus:outline focus:outline-green-400" />
            </div>
            <div>
